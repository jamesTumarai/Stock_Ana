...
const newSearchBar = `<div className={\`liquid-glass !overflow-visible border-white/20 border rounded-xl shadow-2xl p-1.5 md:p-2 w-full flex flex-col md:flex-row md:items-center gap-1 md:gap-2 relative z-30 transition-all focus-within:border-white/40 focus-within:ring-1 focus-within:ring-white/40\`}>
