...
export const samplePltrReport: AnalysisReport = {
  ...
  financial_statements: {
    ...
    balance_sheet: {
      ...
      commentary: 'งบดุลมีความมั่นคงสูงมากระดับไร้หนี้สิน (Zero Debt) พร้อมกระแสเงินสดและสินทรัพย์สภาพคล่องสูงถึง 5 พันล้านดอลลาร์ ทำให้บริษัทมีความยืดหยุ่นในการลงทุน R&D และ M&A โดยไม่ต้องพึ่งพาตลาดตราสารหนี้'
    },
    cash_flow: {
      ...
      commentary: 'คุณภาพกำไรอยู่ในระดับยอดเยี่ยม (High Quality of Earnings) อัตราแปลงกำไรสุทธิเป็น Free Cash Flow สูงกว่า 1.6x โดย FCF Margin ทะลุ 52% ในไตรมาสล่าสุด'
    },
    red_flags: [
  ...
  corporate_actions: {
    ...
    buybacks: {
      ...
      commentary: 'คณะกรรมการบริษัทได้อนุมัติโครงการซื้อหุ้นคืน (Share Repurchase Program) วงเงิน 1,000 ล้านดอลลาร์สหรัฐ เพื่อลดผลกระทบจากการเจือจางของหุ้น (Dilution Mitigation) ที่เกิดจากค่าตอบแทนหุ้นพนักงาน (SBC) โดยยังมีวงเงินคงเหลืออีกกว่า 850 ล้านดอลลาร์'
    }
  },
  company_profile: {
    as_of_date: '2026-09-01',
