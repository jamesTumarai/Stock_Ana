...
12. MANDATORY WALL STREET 12-MONTH CONSENSUS ANCHORING FOR VALUATION SCENARIOS (สมมติฐานและการประเมินมูลค่าต้องอิง Consensus ตลาดข้ามทุก Sector ไม่สลับระหว่าง Base กับ Bull):
  ...
  "financial_charts": {
    ...
    "financial_performance_4q": []
        ...
        if (language && language.toLowerCase() === 'thai') {
          finalInstruction += `\n\nCRITICAL MANDATE - NATURAL INVESTOR THAI (ภาษาคนลงทุนจริง ไม่ใช้ภาษาหุ่นยนต์ AI):
          เขียนบทวิเคราะห์อย่างละเอียด เจาะลึก มีเนื้อหาเข้มข้น ครอบคลุมทั้งเชิงคุณภาพและตัวเลขเชิงปริมาณ (In-depth Comprehensive Analysis) ด้วยภาษาไทยที่นักลงทุนและนักวิเคราะห์หุ้นใช้กันจริงๆ เป็นธรรมชาติ ลื่นไหล เข้าใจง่าย ตรงประเด็น ห้ามใช้ภาษาแปลเครื่องหรือคำประดิษฐ์ของ AI (เช่น "สะท้อนให้เห็นถึง", "ในภูมิทัศน์ที่มีพลวัต", "เป็นสิ่งสำคัญยิ่งยวด", "คูเมืองทางเศรษฐกิจ", "การเจือจางของหุ้น", "หัวเจาะหลักในการเติบโต")
          ...
          - Fundamental Analysis (เน้นการวิเคราะห์อย่างละเอียด เจาะลึก มีเนื้อหาเข้มข้น เขียนเป็นความเรียง/พารากราฟที่อธิบายบริบทและตัวเลขชัดเจน ความยาว 2-3 พารากราฟต่อหัวข้อ ไม่เขียนสรุปสั้นๆ แค่ไม่กี่บรรทัด และห้ามใช้ bullet points ในหัวข้อความเรียงเด็ดขาด):
          1) บริษัทนี้ทำธุรกิจอะไร (for business_overview): อธิบายภาพรวมธุรกิจอย่างละเอียด เจาะลึกว่าหาเงินจากอะไร สินค้าหรือบริการหลักคืออะไร สัดส่วนรายได้มาจากส่วนไหนมากที่สุด และโครงสร้างธุรกิจเชื่อมโยงกันอย่างไร เขียนอธิบายเป็นความเรียง/พารากราฟที่มีเนื้อหาเข้มข้นและเห็นภาพชัดเจน (ความยาว 2-3 พารากราฟ ห้ามใช้ bullet points หรือสรุปสั้น)
          2) ลูกค้าของบริษัทคือใคร (for target_customers): วิเคราะห์กลุ่มลูกค้าหลักอย่างละเอียด ทั้งฝั่ง B2C, B2B หรือ Enterprise พึ่งพาลูกค้ารายใหญ่ไม่กี่รายหรือกระจายตัวดี ต้นทุนในการย้ายค่าย (Switching Cost) หรือ Network Effect เป็นอย่างไร พฤติกรรมลูกค้าและความภักดีต่อแบรนด์ (ความยาว 1-2 พารากราฟแบบเจาะลึก ห้ามใช้ bullet points)
          3) โมเดลรายได้และคุณภาพรายได้ (for revenue_model): เจาะลึกโครงสร้างและโมเดลรายได้ เป็นแบบขายครั้งเดียวหรือรายได้ประจำสม่ำเสมอ (Recurring Revenue) สัญญาการให้บริการ อัตราการต่ออายุ (Retention Rate / Net Expansion Rate) คุณภาพกระแสเงินสด และความแน่นอนในการคาดการณ์รายได้ (ความยาว 1-2 พารากราฟแบบเจาะลึก ห้ามใช้ bullet points)
          4) ภาพรวมงบการเงินล่าสุด (for financial_overview): วิเคราะห์ผลประกอบการไตรมาสล่าสุดและแนวโน้มย้อนหลังอย่างละเอียด รายได้และกำไรเติบโตอย่างไรพร้อมตัวเลขกำกับ อัตรากำไร (Gross Margin, Operating Margin, Net Margin) ดีขึ้นหรือลดลงจากปัจจัยใด กระแสเงินสดจากการดำเนินงานและ FCF เป็นบวกหรือไม่ ภาระหนี้สิน ดอกเบี้ยจ่าย และความเสี่ยงสภาพคล่อง (หากเป็นสถาบันการเงิน ให้วิเคราะห์ NIM, NPL, Provisions และ Tier 1 Capital Ratio แทน) รวมถึง Valuation เมื่อเทียบกับอุตสาหกรรม และผลกระทบจาก Dilution/SBC (ความยาว 2-3 พารากราฟเข้มข้นพร้อมตัวเลขจริง ห้ามใช้ bullet points)
          5) เช็คคุณภาพพื้นฐาน (for fundamentals_check): CRITICAL: คุณต้องตอบให้ครบทั้ง 8 ข้อตามหมวดหมู่นี้อย่างเคร่งครัด ห้ามข้ามหรือตัดทอนเด็ดขาด แต่ละข้อต้องเขียนอย่างน้อย 2-3 ประโยคพร้อมตัวเลขการเงินจริงกำกับ คั่นแต่ละข้อด้วย '\n\n' โดยต้องใช้ Markdown Numbered List ตามรูปแบบนี้เท่านั้น (ห้ามใส่ bullet '-' นำหน้าตัวเลข):
          1. การเติบโตของรายได้ (Revenue Growth): วิเคราะห์อัตราการเติบโตของรายได้ล่าสุด (YoY, QoQ) เทียบกับค่าเฉลี่ยในอดีตและแนวโน้ม
          2. การเติบโตของกำไร (Net Income & EPS Growth): วิเคราะห์การเติบโตของกำไรสุทธิและ Diluted EPS พร้อมปัจจัยขับเคลื่อน
          3. คุณภาพกระแสเงินสดและ FCF (Cash Flow Quality & FCF): วิเคราะห์ Operating Cash Flow, CapEx, FCF Conversion Ratio และความสม่ำเสมอ
          4. ภาระหนี้สินและความเสี่ยงสภาพคล่อง (Debt & Financial Health): วิเคราะห์ Total Debt, Cash & Short-Term Investments, Net Cash/Debt, Interest Coverage หรือ D/E Ratio
          5. ความสามารถในการรักษาอัตรากำไร (Margin Durability): วิเคราะห์ Gross Margin, Operating Margin, Net Margin แนวโน้มการขยายตัวหรือหดตัว
          6. ผลตอบแทนต่อเงินลงทุน (ROIC / ROE): วิเคราะห์ความคุ้มค่าของการนำเงินทุนไปสร้างผลตอบแทน และประสิทธิภาพการใช้สินทรัพย์
          7. รันเวย์และโอกาสเติบโตในระยะยาว (Long-Term Growth Runway): วิเคราะห์ขนาดตลาด (TAM), อัตราการเข้าถึงตลาด และความยั่งยืนของธุรกิจ
          8. บทสรุปภาพรวมและคำตัดสิน (Final Verdict): ฟันธงข้อสรุปสถานะพื้นฐาน เลือกระหว่าง "พื้นฐานแข็งแกร่ง", "มีจุดเด่นแต่ต้องระวัง", หรือ "พื้นฐานยังไม่น่าไว้วางใจ" พร้อมสรุปเหตุผลหลัก
          6) จุดแข็งและความได้เปรียบในการแข่งขัน (for business_strengths): วิเคราะห์ Moat อย่างละเอียด (แบรนด์, ขนาดธุรกิจ, Network Effect, สิทธิบัตร, ต้นทุน หรือ Ecosystem) เปรียบเทียบกับคู่แข่งหลัก 1-2 รายอย่างชัดเจน ระบุจุดที่เหนือกว่าและจุดที่ยังเป็นรอง พร้อมยกตัวอย่างเชิงรูปธรรม (ความยาว 2-3 พารากราฟเจาะลึก ห้ามใช้ bullet points)
          7) โอกาสและปัจจัยเร่งการเติบโต (for future_growth): วิเคราะห์โอกาสสร้างการเติบโตใหม่ ทั้ง New S-Curve, การขยายตลาด/กลุ่มลูกค้าใหม่ และปัจจัยหนุน (Catalysts) ที่น่าจับตาใน 6-12 เดือนข้างหน้า พร้อมประเมินโอกาสความเป็นไปได้ (ความยาว 1-2 พารากราฟเจาะลึก ห้ามใช้ bullet points)
          8) ความเสี่ยงสำคัญที่ต้องจับตา (for key_risks): CRITICAL: คุณต้องตอบให้ครบทั้ง 8 ข้อตามหมวดหมู่นี้อย่างเคร่งครัด ห้ามข้ามหรือตัดทอนเด็ดขาด แต่ละข้อต้องอธิบายอย่างละเอียดอย่างน้อย 2-3 ประโยคพร้อมตัวเลข สถิติ หรือกรณีศึกษาจริง คั่นแต่ละข้อด้วย '\n\n' โดยใช้รูปแบบ Markdown Numbered List ดังนี้ (ห้ามใส่ bullet '-' นำหน้าตัวเลข):
          1. ความเสี่ยงด้านการแข่งขัน (Competition Risk): วิเคราะห์คู่แข่งหลัก ส่วนแบ่งตลาด และแรงกดดันจากการแย่งชิงลูกค้า
          2. ความเสี่ยงด้านการกระจุกตัวของลูกค้าหรือซัพพลายเออร์ (Customer / Supplier Concentration): วิเคราะห์สัดส่วนลูกค้ารายใหญ่หรือการพึ่งพาผู้ผลิต/คู่ค้ารายสำคัญ
          3. ความเสี่ยงด้านกฎระเบียบและข้อกฎหมาย (Regulatory & Antitrust): วิเคราะห์คดีความ การสอบสวน นโยบายกีดกันทางการค้า หรือกฎหมายควบคุม
          4. ความเสี่ยงด้านเศรษฐกิจมหภาคและอัตราแลกเปลี่ยน (Macroeconomic & FX): วิเคราะห์ผลกระทบจากดอกเบี้ย อัตราเงินเฟ้อ กำลังซื้อผู้บริโภค และความผันผวนของค่าเงิน
          5. แรงกดดันต่ออัตรากำไรและต้นทุน (Margin Pressure & Cost Inflation): วิเคราะห์ต้นทุนวัตถุดิบ ค่าแรง ค่าการตลาด หรือสงครามราคาที่อาจบีบมาร์จิ้น
          6. ความเสี่ยงด้าน Valuation และความคาดหวังตลาด (Valuation & Multiple Compression): วิเคราะห์ P/E, EV/EBITDA เทียบกับประวัติศาสตร์และอุตสาหกรรม หากพลาดเป้าอาจถูก Re-rate
          7. ความเสี่ยงแฝงที่มือใหม่มักมองข้าม (Hidden / Blind Spot Risks): วิเคราะห์ความเสี่ยงด้านเทคโนโลยีล้าสมัย (Tech Disruption), การพึ่งพาคีย์แมน หรือความเสี่ยงทางภูมิรัฐศาสตร์
          8. ผลกระทบจากหุ้นเพิ่มทุนและผลตอบแทนพนักงาน (Dilution & SBC Risk): วิเคราะห์การออก Stock-Based Compensation (SBC), อัตราการเพิ่มของจำนวนหุ้น (Share Dilution) และผลกระทบต่อกำไรต่อหุ้น
          9) ฝีมือผู้บริหารและการจัดสรรเงินทุน (for management): วิเคราะห์ผลงานผู้บริหารอย่างละเอียด เจาะลึก Track Record ในอดีต ผลงานจริงทำได้ตามเป้าหมาย (Guidance) ที่เคยให้ไว้ไหม สัดส่วนการถือหุ้นของผู้บริหาร (Insider Ownership) ให้ระบุเป็นตัวเลข % จริง (ถ้าไม่มีข้อมูลให้ระบุว่า "ไม่พบข้อมูลสัดส่วนการถือหุ้นในเอกสารทางการ"), การซื้อขายหุ้นของผู้บริหารล่าสุด, และการจัดสรรเงินทุน (Capital Allocation เช่น การซื้อหุ้นคืน เงินปันผล M&A และ Capex) ผู้บริหารคำนึงถึงผลประโยชน์ผู้ถือหุ้นรายย่อยเพียงใด (ความยาว 2-3 พารากราฟเจาะลึก ห้ามใช้ bullet points)
    ...
    "peers": [
      {
        ...
        "p_ffo_multiple": null,
        "p_affo_multiple": null,
        "occupancy_rate_pct": null,
        "noi_growth_yoy_pct": null,
        "fcf_yield_pct": null,
        "relation_type": null,
        "sector": null,
        "industry": null,
...
5. In "business_analysis.revenue_breakdown":
   ...
   - All segment revenues must sum to total company revenue, and ratio_pct must sum to 100%.`;
        ...
        if (language && language.toLowerCase() === 'thai') {
          finalInstruction += `\n\nCRITICAL MANDATE - NATURAL INVESTOR THAI (ภาษาคนลงทุนจริง ไม่ใช้ภาษาหุ่นยนต์ AI):
          เขียนบทวิเคราะห์ปัจจัยพื้นฐานอย่างละเอียด เจาะลึก มีเนื้อหาเข้มข้น ครอบคลุมทั้งเชิงคุณภาพและตัวเลขเชิงปริมาณ (In-depth Comprehensive Analysis) ด้วยภาษาไทยที่นักลงทุนและนักวิเคราะห์หุ้นใช้กันจริงๆ เป็นธรรมชาติ ลื่นไหล เข้าใจง่าย ตรงประเด็น ห้ามใช้ภาษาแปลเครื่องหรือคำประดิษฐ์ของ AI (เช่น "สะท้อนให้เห็นถึง", "ในภูมิทัศน์ที่มีพลวัต", "เป็นสิ่งสำคัญยิ่งยวด", "คูเมืองทางเศรษฐกิจ", "การเจือจางของหุ้น", "หัวเจาะหลักในการเติบโต")
          ...
          Please follow this specific Fundamental Analysis guideline for the JSON fields in "comprehensive_analysis" (เน้นการวิเคราะห์อย่างละเอียด เจาะลึก มีเนื้อหาเข้มข้น เขียนเป็นความเรียง/พารากราฟที่อธิบายบริบทและตัวเลขชัดเจน ความยาว 2-3 พารากราฟต่อหัวข้อ ไม่เขียนสรุปสั้นๆ แค่ไม่กี่บรรทัด และห้ามใช้ bullet points ในหัวข้อความเรียงเด็ดขาด):
          1) บริษัทนี้ทำธุรกิจอะไร (for business_overview): อธิบายภาพรวมธุรกิจอย่างละเอียด เจาะลึกว่าหาเงินจากอะไร สินค้าหรือบริการหลักคืออะไร สัดส่วนรายได้มาจากส่วนไหนมากที่สุด และโครงสร้างธุรกิจเชื่อมโยงกันอย่างไร เขียนอธิบายเป็นความเรียง/พารากราฟที่มีเนื้อหาเข้มข้นและเห็นภาพชัดเจน (ความยาว 2-3 พารากราฟ ห้ามใช้ bullet points หรือสรุปสั้น)
          2) ลูกค้าของบริษัทคือใคร (for target_customers): วิเคราะห์กลุ่มลูกค้าหลักอย่างละเอียด ทั้งฝั่ง B2C, B2B หรือ Enterprise พึ่งพาลูกค้ารายใหญ่ไม่กี่รายหรือกระจายตัวดี ต้นทุนในการย้ายค่าย (Switching Cost) หรือ Network Effect เป็นอย่างไร พฤติกรรมลูกค้าและความภักดีต่อแบรนด์ (ความยาว 1-2 พารากราฟแบบเจาะลึก ห้ามใช้ bullet points)
          3) โมเดลรายได้และคุณภาพรายได้ (for revenue_model): เจาะลึกโครงสร้างและโมเดลรายได้ เป็นแบบขายครั้งเดียวหรือรายได้ประจำสม่ำเสมอ (Recurring Revenue) สัญญาการให้บริการ อัตราการต่ออายุ (Retention Rate / Net Expansion Rate) คุณภาพกระแสเงินสด และความแน่นอนในการคาดการณ์รายได้ (ความยาว 1-2 พารากราฟแบบเจาะลึก ห้ามใช้ bullet points)
          4) ภาพรวมงบการเงินล่าสุด (for financial_overview): วิเคราะห์ผลประกอบการไตรมาสล่าสุดและแนวโน้มย้อนหลังอย่างละเอียด รายได้และกำไรเติบโตอย่างไรพร้อมตัวเลขกำกับ อัตรากำไร (Gross Margin, Operating Margin, Net Margin) ดีขึ้นหรือลดลงจากปัจจัยใด กระแสเงินสดจากการดำเนินงานและ FCF เป็นบวกหรือไม่ ภาระหนี้สิน ดอกเบี้ยจ่าย และความเสี่ยงสภาพคล่อง (หากเป็นสถาบันการเงิน ให้วิเคราะห์ NIM, NPL, Provisions และ Tier 1 Capital Ratio แทน) รวมถึง Valuation เมื่อเทียบกับอุตสาหกรรม และผลกระทบจาก Dilution/SBC (ความยาว 2-3 พารากราฟเข้มข้นพร้อมตัวเลขจริง ห้ามใช้ bullet points)
          ...
          7. ความเสี่ยงแฝงที่มือใหม่มักมองข้าม (Hidden / Blind Spot Risks): วิเคราะห์ความเสี่ยงด้านเทคโนโลยีล้าสมัย (Tech Disruption), การพึ่งพาคีย์แมน หรือความเสี่ยงทางภูมิรัฐศาสตร์
          8. ผลกระทบจากหุ้นเพิ่มทุนและผลตอบแทนพนักงาน (Dilution & SBC Risk): วิเคราะห์การออก Stock-Based Compensation (SBC), อัตราการเพิ่มของจำนวนหุ้น (Share Dilution) และผลกระทบต่อกำไรต่อหุ้น
          9) ผู้บริหารและการจัดสรรเงินทุน (for management): วิเคราะห์ผลงานผู้บริหารอย่างละเอียด เจาะลึก Track Record ในอดีต ผลงานจริงทำได้ตามเป้าหมาย (Guidance) ที่เคยให้ไว้ไหม สัดส่วนการถือหุ้นของผู้บริหาร (Insider Ownership) ให้ระบุเป็น % ตัวเลขจริง (ถ้าไม่มีให้ระบุว่า "ไม่พบข้อมูลสัดส่วนการถือหุ้นในเอกสารทางการ"), การซื้อขายหุ้นของผู้บริหารล่าสุด, และการจัดสรรเงินทุน (Capital Allocation เช่น การซื้อหุ้นคืน เงินปันผล M&A และ Capex) ผู้บริหารคำนึงถึงผลประโยชน์ผู้ถือหุ้นรายย่อยเพียงใด (ความยาว 2-3 พารากราฟเจาะลึก ห้ามใช้ bullet points)
          10) สรุปให้มือใหม่เข้าใจง่าย (for beginner_summary): 
          ...
          - เน้นข้อเท็จจริง ตัวเลข และเหตุผล ห้ามใช้คำเยิ่นเย้อหรือคำชมลอยๆ โดยไม่มีข้อมูลสนับสนุน
          - ตัวเลขประเภท "นับต่อเนื่อง" ต้องแม่นยำเป๊ะ ห้ามประมาณ ถ้านับไม่ได้ให้บอกว่า "ไม่สามารถยืนยันจำนวนไตรมาสที่แน่นอนได้"
          - แต่ละหัวข้อ (1-12) ต้องตอบครบถ้วน มีเนื้อหาเข้มข้นเชิงลึก ไม่ข้ามประเด็นสำคัญ และไม่สรุปสั้นห้วน
          - อธิบายศัพท์ยากเป็นภาษาง่าย ตอบแบบภาษาคนลงทุนจริง`;
        } else {
          finalInstruction += `\n\nCRITICAL: You MUST write ALL string values in the JSON output in English.
          CRITICAL REQUIREMENTS:
          - Write comprehensive, in-depth multi-paragraph analytical explanations for "comprehensive_analysis" fields ("business_overview", "target_customers", "revenue_model", "financial_overview", "business_strengths", "future_growth", and "management"). Provide deep context, industry dynamics, and numerical backing (2-3 paragraphs each). DO NOT use bullet points in these narrative sections; write in full continuous paragraphs.
          - For Topic 5 (fundamentals_check): This field MUST NEVER BE EMPTY. You MUST use a markdown numbered list (1. to 8.) assessing all 8 distinct areas with at least 2-3 sentences each: 1. Revenue Growth 2. Net Income & EPS Growth 3. Cash Flow Quality & FCF 4. Debt & Liquidity 5. Margin Durability 6. ROIC / ROE 7. Long-Term Growth Runway 8. Final Verdict (Strong, Caution, or Weak).
          - For Topic 8 (key_risks): You MUST cover all 8 risk categories (1. to 8.) with at least 2-3 sentences and numerical backing for each: 1. Competition Risk 2. Customer / Supplier Concentration 3. Regulatory & Antitrust 4. Macro & FX 5. Margin Pressure 6. Valuation & Multiple Compression 7. Hidden / Blind Spot Risks 8. Dilution & SBC Risk.
          - For Topic 9 (management): You MUST provide the exact numerical percentage (%) for insider ownership. If not found, explicitly state "Insider ownership data not found in documents." You must analyze capital allocation (buybacks, dividends, M&A) and evaluate management track record critically in 2-3 rich paragraphs.
...
CRITICAL: ALL technical indicator values (RSI, MACD, ADX, ATR, etc.) MUST be exact single current values. DO NOT report them as ranges (e.g., 35-42 is FORBIDDEN). When stating quantitative facts like "consecutive profitable quarters", YOU MUST BE ABSOLUTELY PRECISE. Count backward exactly from the latest available data. Do NOT guess or round numbers. If the exact consecutive count cannot be confirmed, state "Cannot confirm exact consecutive count" instead of providing an inaccurate number.
          You MUST provide HIGHLY DETAILED, EXTREMELY IN-DEPTH analysis for every field. Do not write short or brief sentences. Elaborate thoroughly with quantitative backing, verified figures, and detailed explanations.
          CRITICAL FORMATTING MANDATE FOR ANALYSIS FIELDS:
          - For narrative sections in comprehensive_analysis ('business_overview', 'target_customers', 'revenue_model', 'financial_overview', 'business_strengths', 'future_growth', 'management'): Write in rich, continuous multi-paragraph prose/paragraphs (2-3 paragraphs each, separated by double newlines '\n\n') using bold text and numbers for emphasis. DO NOT use bullet points ('- ') or numbered lists in these narrative sections; write in full flowing paragraphs.
...
${analysisType !== 'fundamental' ? `- Technical Trade Plan: Ensure Risk/Reward ratio for BOTH Target 1 and Target 2 is mathematically correct. CRITICAL: You MUST format the R:R ratios cleanly as a 3-column Markdown table or distinct bullet points (Target | Formula | Result) so it is easy to read. Do NOT cram the R:R calculation into a single long string.
...
- Technical Trade Plan Formatting: Make sure the R:R calculation in 'trade_plan' is nicely formatted as a Markdown table (Target | Formula | Result) using proper \\n newlines.` : ''}
- Comprehensive Fundamental Analysis Depth & Narrative Prose Mandate:
  * For 'business_overview', 'target_customers', 'revenue_model', 'financial_overview', 'business_strengths', 'future_growth', and 'management': Ensure they are written in rich, detailed, multi-paragraph continuous prose (2-3 paragraphs each with concrete numbers, business context, and industry dynamics).
  * CRITICAL FAIL-SAFE: If the Primary Analyst formatted ANY of these fields as bullet points ('- ') or wrote brief summaries, you MUST rewrite and expand them into full, flowing 2-3 paragraph prose with deep context. DO NOT preserve bullet points in narrative fields.
- Fundamental Fundamentals Check Completeness Mandate:
  * Must have ALL 8 numbered points (1. to 8.) with detailed assessments (at least 2-3 sentences each with real financial figures):
    1. Revenue Growth
    2. Net Income & EPS Growth
    3. Cash Flow Quality & FCF
    4. Debt & Liquidity
    5. Margin Durability
    6. ROIC / ROE
    7. Long-Term Growth Runway
    8. Final Verdict ("พื้นฐานแข็งแกร่ง", "มีจุดเด่นแต่ต้องระวัง", หรือ "พื้นฐานยังไม่น่าไว้วางใจ")
  * CRITICAL FAIL-SAFE: If the Primary Analyst omitted any points, truncated the list, or provided fewer than 8, you MUST actively complete all 8 points in full.
- Fundamental Key Risks Completeness Mandate:
  * Must cover ALL 8 risk categories (1. to 8.) with rich explanations and data backing (at least 2-3 sentences each):
    1. Competition Risk
    2. Customer / Supplier Concentration
    3. Regulatory & Antitrust
    4. Macroeconomic & FX
    5. Margin Pressure & Cost Inflation
    6. Valuation & Multiple Compression
    7. Hidden / Blind Spot Risks
    8. Dilution & SBC Risk
  * CRITICAL FAIL-SAFE: If the Primary Analyst truncated the risks (e.g. stopped at 2 or 5 categories), you MUST actively research and complete all 8 categories in full.
