  ...
  "financial_charts": {
    ...
    "financial_performance_4q": []
        ...
        if (language && language.toLowerCase() === 'thai') {
          ...
          - Fundamental Analysis (เน้นการวิเคราะห์อย่างละเอียด เจาะลึก มีเนื้อหาเข้มข้น เขียนเป็นความเรียง/พารากราฟที่อธิบายบริบทและตัวเลขชัดเจน ความยาว 2-3 พารากราฟต่อหัวข้อ ไม่เขียนสรุปสั้นๆ แค่ไม่กี่บรรทัด หรือทำเป็นข้อย่อยสั้นๆ):
          1) บริษัทนี้ทำธุรกิจอะไร (for business_overview): อธิบายภาพรวมธุรกิจอย่างละเอียด เจาะลึกว่าหาเงินจากอะไร สินค้าหรือบริการหลักคืออะไร สัดส่วนรายได้มาจากส่วนไหนมากที่สุด และโครงสร้างธุรกิจเชื่อมโยงกันอย่างไร เขียนอธิบายเป็นความเรียง/พารากราฟที่มีเนื้อหาเข้มข้นและเห็นภาพชัดเจน (ความยาว 2-3 พารากราฟ ไม่เขียนสั้นแค่ไม่กี่บรรทัด)
          2) ลูกค้าของบริษัทคือใคร (for target_customers): วิเคราะห์กลุ่มลูกค้าหลักอย่างละเอียด ทั้งฝั่ง B2C, B2B หรือ Enterprise พึ่งพาลูกค้ารายใหญ่ไม่กี่รายหรือกระจายตัวดี ต้นทุนในการย้ายค่าย (Switching Cost) หรือ Network Effect เป็นอย่างไร พฤติกรรมลูกค้าและความภักดีต่อแบรนด์ (ความยาว 1-2 พารากราฟแบบเจาะลึก)
          3) โมเดลรายได้และคุณภาพรายได้ (for revenue_model): เจาะลึกโครงสร้างและโมเดลรายได้ เป็นแบบขายครั้งเดียวหรือรายได้ประจำสม่ำเสมอ (Recurring Revenue) สัญญาการให้บริการ อัตราการต่ออายุ (Retention Rate / Net Expansion Rate) คุณภาพกระแสเงินสด และความแน่นอนในการคาดการณ์รายได้ (ความยาว 1-2 พารากราฟแบบเจาะลึก)
          4) ภาพรวมงบการเงินล่าสุด (for financial_overview): วิเคราะห์ผลประกอบการไตรมาสล่าสุดและแนวโน้มย้อนหลังอย่างละเอียด รายได้และกำไรเติบโตอย่างไรพร้อมตัวเลขกำกับ อัตรากำไร (Gross Margin, Operating Margin, Net Margin) ดีขึ้นหรือลดลงจากปัจจัยใด กระแสเงินสดจากการดำเนินงานและ FCF เป็นบวกหรือไม่ ภาระหนี้สิน ดอกเบี้ยจ่าย และความเสี่ยงสภาพคล่อง (หากเป็นสถาบันการเงิน ให้วิเคราะห์ NIM, NPL, Provisions และ Tier 1 Capital Ratio แทน) รวมถึง Valuation เมื่อเทียบกับอุตสาหกรรม และผลกระทบจาก Dilution/SBC (ความยาว 2-3 พารากราฟเข้มข้นพร้อมตัวเลขจริง)
          5) เช็คคุณภาพพื้นฐาน (for fundamentals_check): CRITICAL: This field MUST NEVER BE EMPTY. You MUST use a Markdown NUMBERED list (1., 2., 3.) to assess these 8 areas in detail, using '\n\n' to separate each point. Each point must contain at least 2-3 sentences with specific numbers. DO NOT use bullets ('- ') before the numbers: 1.การเติบโตของรายได้ 2.การเติบโตของกำไร 3.คุณภาพกระแสเงินสด 4.ภาระหนี้สินและความเสี่ยงทางการเงิน 5.ความสามารถในการรักษาอัตรากำไร (Margins) 6.ผลตอบแทนต่อเงินลงทุน (ROIC/ROE) 7.โอกาสการเติบโตในระยะยาว 8.บทสรุปภาพรวม ("พื้นฐานแข็งแกร่ง", "มีจุดเด่นแต่ต้องระวัง", หรือ "พื้นฐานยังไม่น่าไว้วางใจ")
          6) จุดแข็งและความได้เปรียบในการแข่งขัน (for business_strengths): วิเคราะห์ Moat อย่างละเอียด (แบรนด์, ขนาดธุรกิจ, Network Effect, สิทธิบัตร, ต้นทุน หรือ Ecosystem) เปรียบเทียบกับคู่แข่งหลัก 1-2 รายอย่างชัดเจน ระบุจุดที่เหนือกว่าและจุดที่ยังเป็นรอง พร้อมยกตัวอย่างเชิงรูปธรรม (ความยาว 2-3 พารากราฟเจาะลึก)
          7) โอกาสและปัจจัยเร่งการเติบโต (for future_growth): วิเคราะห์โอกาสสร้างการเติบโตใหม่ ทั้ง New S-Curve, การขยายตลาด/กลุ่มลูกค้าใหม่ และปัจจัยหนุน (Catalysts) ที่น่าจับตาใน 6-12 เดือนข้างหน้า พร้อมประเมินโอกาสความเป็นไปได้ (ความยาว 1-2 พารากราฟเจาะลึก)
          8) ความเสี่ยงสำคัญที่ต้องจับตา (for key_risks): CRITICAL: You MUST cover at least 8 risk categories (การแข่งขัน, การกระจุกตัวของลูกค้า, นโยบายและกฎหมาย, ภาวะเศรษฐกิจมหภาค, แรงกดดันต่ออัตรากำไร, Valuation ที่อาจตึงตัว, ความเสี่ยงแฝงที่คนมักมองข้าม, Dilution/SBC) แต่ละข้อให้อธิบายเนื้อหาอย่างละเอียดอย่างน้อย 2-3 ประโยคพร้อมตัวเลขและเหตุการณ์จริงประกอบ (ใช้ Markdown numbered lists เช่น "1. ", "2. " และห้ามใช้ "- 1." เด็ดขาด)
...
5. In "business_analysis.revenue_breakdown":
   ...
   - All segment revenues must sum to total company revenue, and ratio_pct must sum to 100%.`;
        ...
        if (language && language.toLowerCase() === 'thai') {
          ...
          6) จุดแข็งและความได้เปรียบในการแข่งขัน (for business_strengths): วิเคราะห์ Moat อย่างละเอียด (แบรนด์, ขนาดธุรกิจ, Network Effect, สิทธิบัตร, ต้นทุน หรือ Ecosystem) เปรียบเทียบกับคู่แข่งหลัก 1-2 รายอย่างชัดเจน ระบุจุดที่เหนือกว่าและจุดที่ยังเป็นรอง พร้อมยกตัวอย่างเชิงรูปธรรม (ความยาว 2-3 พารากราฟเจาะลึก)
          7) โอกาสและปัจจัยเร่งการเติบโต (for future_growth): วิเคราะห์โอกาสสร้างการเติบโตใหม่ ทั้ง New S-Curve, การขยายตลาด/กลุ่มลูกค้าใหม่ และปัจจัยหนุน (Catalysts) ที่น่าจับตาใน 6-12 เดือนข้างหน้า พร้อมประเมินโอกาสความเป็นไปได้ (ความยาว 1-2 พารากราฟเจาะลึก)
          8) ความเสี่ยงสำคัญที่ต้องจับตา (for key_risks): CRITICAL: คุณต้องตอบให้ครบทั้ง 8 หมวดต่อไปนี้ ห้ามข้ามเด็ดขาด แต่ละหมวดต้องเขียนอธิบายอย่างน้อย 2-3 ประโยคพร้อมตัวเลขและเหตุการณ์จริงประกอบ (ใช้ Markdown numbered list 1.-8.): 1.การแข่งขัน 2.ลูกค้ากระจุกตัว 3.กฎระเบียบและข้อกฎหมาย (Antitrust / Regulation) 4.เศรษฐกิจมหภาค 5.แรงกดดันต่อ Margin 6.Valuation ตึงตัว 7.ความเสี่ยงที่มือใหม่มักมองข้าม 8.การเพิ่มขึ้นของจำนวนหุ้น (Dilution/SBC)
          ...
          - Write comprehensive, in-depth multi-paragraph analytical explanations for "comprehensive_analysis" fields ("business_overview", "target_customers", "revenue_model", "financial_overview", "business_strengths", "future_growth", and "management"). Provide deep context, industry dynamics, and numerical backing (2-3 paragraphs each). Do NOT write brief, superficial summaries.
          - For Topic 5 (fundamentals_check): This field MUST NEVER BE EMPTY. You MUST use a markdown numbered list (1., 2., 3.) to assess these 8 areas in detail with at least 2-3 sentences per item: 1.Revenue growth 2.Profit growth 3.Cash flow 4.Debt 5.Margin 6.ROIC/ROE/ROA 7.Growth runway 8.Final verdict (Strong, Caution, or Weak).
          ...
          - For Topic 9 (management): You MUST provide the exact numerical percentage (%) for insider ownership. If not found, explicitly state "Insider ownership data not found in documents." You must analyze capital allocation (buybacks, dividends, M&A) and evaluate management track record critically.
...
- Comprehensive Fundamental Analysis Depth: Ensure that 'business_overview', 'target_customers', 'revenue_model', 'financial_overview', 'business_strengths', 'future_growth', and 'management' maintain their rich, detailed, multi-paragraph in-depth analysis (2-3 paragraphs each with concrete numbers, business context, and industry dynamics). DO NOT compress, shorten, or convert them into superficial bullet points.
...
- Fundamental Fundamentals Check: Must have exactly 8 numbered points with detailed, comprehensive assessments (each point must have at least 2-3 sentences with exact financial figures/facts).
- Fundamental Key Risks: Must cover all 8 risk categories (Competition, Customer concentration, Regulatory, Macro, Margin pressure, Valuation, Hidden risks, Dilution/SBC) with rich, detailed explanations and numerical backing (at least 2-3 sentences per category).
